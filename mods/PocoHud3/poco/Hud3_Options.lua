...
local scheme = {
	root = { '_opt_root_desc',
		...
		endStat  = {'num',1,{0,5},'_opt_endStat_desc','ChatSend',nil,3},
		dominated  = {'num',1,{0,5},'_opt_dominated_desc','ChatSend',nil,4},
		converted  = {'num',1,{0,5},'_opt_converted_desc','ChatSend',nil,4},
		minionLost  = {'num',1,{0,5},'_opt_minionLost_desc','ChatSend',nil,4},
		minionShot  = {'num',1,{0,5},'_opt_minionShot_desc','ChatSend',nil,4},
		custody  = {'num',1,{0,5},'_opt_custody_desc','ChatSend',nil,4},
		downed  = {'num',1,{0,5},'_opt_downed_desc','ChatSend',nil,4},
		downedWarning  = {'num',1,{0,5},'_opt_downedWarning_desc','ChatSend',nil,4},
		replenished  = {'num',1,{0,5},'_opt_replenished_desc','ChatSend',nil,4},
		replenishedFAK = {'num',1,{0,5},"_opt_replenishedFAK_desc","ChatSend",nil,4},
		messiah  = {'num',1,{0,5},'_opt_messiah_desc','ChatSend',nil,5},
		...
		drillDone = {'num',1,{0,5},'_opt_drillDone_desc','ChatSend',nil,6},
		drillAlmostDone = {'num',1,{0,5},'_opt_drillAlmostDone_desc','ChatSend',nil,6},
	}, hit = { '_opt_hit_desc',
		enable = {'bool',TRUE,nil,'_opt_enable_desc'},
